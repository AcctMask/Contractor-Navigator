    ...
    const steps = [
        {
            delay_hours: 0,
            step_order: 1,
            message: "Hi {{name}}, just confirming you received the estimate. Let me know if you'd like to review options.",
        },
        {
            delay_hours: 24,
            step_order: 2,
            message: "Hi {{name}}, just checking in to see if you had any questions about the estimate.",
        },
        {
            delay_hours: 72,
            step_order: 3,
            message: "Hi {{name}}, wanted to follow up again regarding the estimate. I'm happy to review details with you.",
        },
        {
            delay_hours: 96,
            step_order: 4,
            message: "Hi {{name}}, I don't want to bother you. If now isn't the right time just let me know.",
        },
    ];
